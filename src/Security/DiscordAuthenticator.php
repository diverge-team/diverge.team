...
class DiscordAuthenticator extends AbstractAuthenticator
{
    ...
    {
        return 'app_account_security_auth' === $request->attributes->get('_route') && $this->isValidRequest($request);
    }
    ...
    public function onAuthenticationFailure(Request $request, AuthenticationException $exception): ?Response
    {
        ...
        return new RedirectResponse($this->router->generate('app_account_security_login'));
    }
